...
// set contract name
contract BCGHeroesTickets3 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    uint256 public constant MAX_TICKET = 10001;   //set (exclusive)
    uint256 public constant MINT_PRICE = 1 ether; //set

    bool[1112] chimpsBCG;
    bool[864] chimpsBCGX;

    constructor() ERC721("BCGHeroes-Tickets3", "BCGH-T3") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "ipfs://QmcfazhGDXZT2VEbdnD7f4YznRVHDqKHMTufaMKXe5Tds6/";
    }
    ...
    function MintHundredTickets() public payable {
        require(mintable, 'Tickets are not mintable yet.');
        require(_tokenIdCounter.current() + 99 < MAX_TICKET, 'All the Tickets are minted.');
        require(msg.value >= MINT_PRICE * 100, 'Not the right payment.');
        uint256 index;
    ...
    function MintTwohundredFiftyTickets() public payable {
        require(mintable, 'Tickets are not mintable yet.');
        require(_tokenIdCounter.current() + 249 < MAX_TICKET, 'All the Tickets are minted.');
        require(msg.value >= MINT_PRICE * 250, 'Not the right payment.');
        uint256 index;
